...
export const Casestudy5 = ({
  ...
  return (
    <section>
      <div className="mx-auto max-w-6xl px-6 py-20 pt-10">
        <div className="border border-border border-line">
          <a
          ...
          >
            ...
            <div className="relative isolate py-16">
              <div className="relative isolate h-full border border-border border-line bg-background p-2">
          ...
          <div className="flex border-t border-border border-line ">
              ...
              {casestudies.map((item, idx) => (
                <a
                  ...
                  className={`group flex flex-col justify-between gap-12 border-border bg-background px-6 py-8 transition-colors duration-500 ease-out hover:bg-muted/40 md:py-16 lg:pb-16 xl:gap-16 ${
                    idx === 0
                      ? "xl:border-l xl:pl-8 border-line"
                      : "border-t lg:border-t-0 lg:border-l xl:border-r xl:pl-8 border-line"
                  }`}
                >
                  <div className="flex items-center gap-2 text-2xl font-medium">
